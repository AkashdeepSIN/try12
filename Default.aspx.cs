...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Radwin1.Checked == true)
            tot_win = tot_win + 1;
        else if (Radloss1.Checked == true)
            tot_loss = tot_loss + 1;

        if (Radwin2.Checked == true)
            tot_win = tot_win + 1;
        else if (Radloss2.Checked == true)
            tot_loss = tot_loss + 1;
        if (Radwin3.Checked == true)
            tot_win = tot_win + 1;
        else if (Radloss3.Checked == true)
            tot_loss = tot_loss + 1;
        if (Radwin4.Checked == true)
            tot_win = tot_win + 1;
        else if (Radloss4.Checked == true)
            tot_loss = tot_loss + 1;
